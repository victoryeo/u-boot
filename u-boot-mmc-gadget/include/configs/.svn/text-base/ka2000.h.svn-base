 ...
 * Flash drivers
 */
#define CONFIG_KA2000_SPI	/* KA SPI driver, drivers/spi/ka2000_spi.c */
# define CONFIG_ENV_SPI_BUS             0
# define CONFIG_ENV_SPI_CS              0

#define CONFIG_SPI_FLASH
#define CONFIG_SPI_FLASH_MACRONIX	/* Macronix, not work well. */
...
#define CONFIG_USB_GADGET_KAGEN2_UDC        1
//#define CONFIG_USB_TTY                  1

#if 0
/* USB OHCI host config */
#define CONFIG_USB_OHCI
#define CONFIG_USB_OHCI_NEW
#define CONFIG_SYS_USB_OHCI_MAX_ROOT_PORTS	1
#define CONFIG_SYS_USB_OHCI_REGS_BASE  0xa0010000
#define CONFIG_SYS_USB_OHCI_SLOT_NAME	"kagen2"
...
/*#define CONFIG_EXTRA_ENV_SETTINGS	\
	"boot_sd=mmc init; fatload mmc 1 208000 image; fatload mmc 1 500000 initramfs.gz; go 208000\0"	\
...
#endif
#define CONFIG_SYS_BAUDRATE_TABLE       {19200, 38400}  //{ 9600, 19200, 38400, 57600, 115200 }   /*Valid baudrates */
...
#else
#define CONFIG_BOOTDELAY                    -1 //3                                       /*Delay (sec) b4 autoboot image, -1 disable autoboot */
#define CONFIG_BOOTCOMMAND                  "run bootf"    //bootcmd
#endif
...
#ifndef CONFIG_SYS_PROGRAM_BIN // For autoload
#define CONFIG_SYS_TEXT_BASE            0x00002E00
#else // For testing
#define CONFIG_SYS_TEXT_BASE            0x00E00000
#endif

/* Environment */
#define CONFIG_ENV_SIZE                 (32 * 1024)                                 /* Total size of ENV */
...
/* Size of SDRAM reserved for  malloc() & relocated env. 6M for Kernel + RAM Disk. */
#define CONFIG_SYS_MALLOC_LEN           (CONFIG_ENV_SIZE + (4 * 1024 * 1024))
#define CONFIG_SYS_GBL_DATA_SIZE        (32*1024)                                   /* Space in bytes reserved for initial data */
#define CONFIG_STACKSIZE                (256* 1024)                            /* Regular stack (stack sizes are set up in start.S) */
...
#define CONFIG_BOARD_LATE_INIT                                                 /*Do board init with board_late_init() */
...
//#define CONFIG_KA_LOGCONSOLE
#ifdef CONFIG_KA_LOGCONSOLE
#define KA_LOGCON_ADDR		(8 * 1024 * 1024 + 2048)
#define KA_LOGCON_SIZE		(8 * 1024)
#endif /* CONFIG_KA_LOG */

//#define CONFIG_RECORD_CMD_ENABLE
#ifdef CONFIG_RECORD_CMD_ENABLE
#define CONFIG_RECORD_CMD_AUTO
#define CONFIG_RECORD_CMD_QUIET
