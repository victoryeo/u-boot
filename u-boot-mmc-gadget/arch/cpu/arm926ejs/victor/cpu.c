...
void set_clock(int mhz)
{
	...
	debug("0xa0000004 %08x\n", word_read(0xa0000004));
	debug("0xa0000008 %08x\n", word_read(0xa0000008));
	debug("0xa000000c %08x\n", word_read(0xa000000c));
...
end_setclk:
	word_write(0xa0000008, 0x00101010);     //0x00040404 //0x00080808 //0x04040404
...
//	uint32_t reg;
	...
	buzzer_on(1);
#ifndef CONFIG_SYS_DISABLE_DCACHE
	pagetbl_init();
